...
const messages = {
  en: {
    ...
    home: {
      ...
      list_1: [
        'Pablo Renard Guiral (p.renard.guiral@gmail.com)',
        'Sunayana Maben (smaben@nao.cas.cn)',
        'Hsu-Wen Chiang (jiangxw@sustech.edu.cn)',
        'Huan Zhou (zhouh237@mail3.sysu.edu)',
        'Yun-Feng Wei (yfwei@xmu.edu.cn)',
